...
def download_image_if_missing(docker_client, repository, tag):
    """
    ...
    redis_images = docker_client.images(name=repository)
    ...
    if not proper_image_exists:
        ...
        docker_client.pull(repository=repository, tag=tag)
